...
public class FindOccurrence {
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            if (firstOccur == -1) {
                ...
                System.out.println("Element's first occurrence found at index: " + firstOccur);
            }
            ...
            if (lastOccur == -1) {
                ...
                System.out.println("Element's last occurrence found at index: " + lastOccur);
            }

            System.out.print("All occurrences of " + key + " in the array: ");
            printAllOcc(arr, key, 0);

        }
    }

    /**
     * Recursively finds the first occurrence of an element in the array
     * 
     * <p>
     ...
     * @param key The element whose first occurrence is to be returned
    ...
    /**
     * Recursively finds the last occurrence of an element in an array
     * 
     * <p>
     * Time Complexity: O(n), one call per element
     * <p>
    ...
    /**
     * Recursively prints all occurrences of an element in the array
     * 
     * <p>
     * Time Complexity: O(n), one call per element
     * <p>
     ...
     * @param i   The starting position of the search in the array for the key
     */
    public static void printAllOcc(int[] arr, int key, int i) {
        if (i == arr.length) {
            return;
        }
        if (arr[i] == key) {
